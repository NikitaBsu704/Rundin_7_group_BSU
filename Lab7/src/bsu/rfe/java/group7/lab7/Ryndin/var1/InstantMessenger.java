...
{
	//final MainFrame UserFrame;///поле связи с MainFrame (похоже не нужно)
	
	//string message можно записать сообщение сюда - а затем из MainFrame получить доступ методами MainFrame к данным, после уведомления
	...
	public void sendMessage(final String destinationAddress,final int Port,String message) 
	{
		try 
		{
			// Необходимые параметры получены
