...
public class JoinServer implements Runnable 
{
	...
	///Ќаши чаты, на которые перенаправл€ем
				...
				try 
				{
					...
					while (!Thread.interrupted()) 
					{
						...
						try {
								...
								*/
								///админ не зашел - провер€ем дальше
								int i = 0;
								...
								if(Equal)
								{
									////ћы начинаем с системного если совпадений нет - тогда ситемный чат по умолчанию
									i = 0;
									...
									if(Equal) 
									{
										try 
										{
										///дл€ начала отправим запрос на добавление пользовател€ чат-серверу
										...
										*/
										...
										{
											// ≈сли нас прервали, то что-то нужно делать...
									...
									/// перенаправить пользовател€ на системный чат по умолчанию
									else 
									{
								...
								/// Ќеверна€ комбинаци€ - проигнорировать
								else 
								{
