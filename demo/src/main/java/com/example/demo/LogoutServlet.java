...
// Перенаправить на главную страницу
                ...
                ///сообщить о выходе пользователя
                ChatUser SystemBot = activeUsers.get("System");
                String SystemMessage = name+" left this server";
            ...
            if (aUser.getSessionId().equals((String) request.getSession().getId()))
               {
                   ...
                   response.sendRedirect(response.encodeRedirectURL("/demo_war_exploded/view.htm"));
                   messages.add(new ChatMessage("NEW_USER_IN_THE_CHAT", aUser,Calendar.getInstance().getTimeInMillis()));
                }
    }
}}
